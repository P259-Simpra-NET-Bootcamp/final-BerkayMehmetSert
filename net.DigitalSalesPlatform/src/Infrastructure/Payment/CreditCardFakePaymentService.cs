...
public class CreditCardFakePaymentService : IFakePaymentService
{
    ...
    {
        Console.WriteLine(PaymentBusinessMessages.SuccessfulPaymentCreditCard, amount, maskedCreditCardNumber);
        return true;
    }
}